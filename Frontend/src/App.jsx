...
import { currentUser } from "./store/User/user-action"; // Now used
...
function App() {
  ...
  // FIX 1: Fetch user on load (to check cookies)
  useEffect(() => {
    dispatch(currentUser());
  }, [dispatch]);

  // FIX 3: Error clearing useEffect now runs when 'errors' changes
  useEffect(()=>{
    if(errors){
